<template>
    <div class="body1 mx-auto br">
        ...
        <!-- 戰鬥按鈕 中間左邊-->
        <button type="submit" class="btnfight1" @click="changePage('game')" @mouseover="fightover" @mouseleave="fightleave"
            v-bind:style="{ backgroundImage: 'url(' + fightimg1 + ')' }"></button>
        <!-- 箱子按鈕 中間左邊-->
